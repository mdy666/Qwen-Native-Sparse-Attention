import importlib
from triton_kernel.fused_add_norm import triton_fused_add_norm
from triton_kernel.fused_silu import triton_fused_up_gate_silu
from triton_kernel.rmsnorm import triton_rmsnorm
from triton_kernel.fused_apply_rope import fused_apply_rope
from triton_kernel.cross_entyopy_loss import triton_entropy_loss
...
def causal_forward(
    ...
    **kwargs,
    ...
    if labels is not None:
        loss = triton_entropy_loss(logits, labels, kwargs.get('num_items_in_batch', None))
